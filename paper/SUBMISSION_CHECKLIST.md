KBS short communication — files aligned to
https://www.sciencedirect.com/journal/knowledge-based-systems/publish/guide-for-authors

Article type
Short communication (max 10 double-spaced pages including tables and figures).

Submit in Editorial Manager as editable sources (.docx or .tex). PDF is not an acceptable source file.
...
5. Upload Figure_1 and Figure_2 as separate files; captions stay in the manuscript, not on the artwork.
6. Complete Elsevier competing-interest Word form in the submission system.
7. Edit or delete the generative-AI declaration if it does not match how you prepared the final text.
8. Do not add more than two figures or two tables to the letter.
